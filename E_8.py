...
def binary_a(n):
    ...
    binary[0] = np.array([0,0,0,0,0,0,0,2]) 
    binary[1] = np.array([0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 2.5])
    binary[2] = np.array([-0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 3.5])
    binary[3] = np.array([0,0,1,1,1,1,1,5])
    binary[4] = np.array([0,0,0,1,1,1,1,4])
    binary[5] = np.array([0,0,0,0,1,1,1,3])
    binary[6] = np.array([0,0,0,0,0,1,1,2])
    binary[7] = np.array([0,0,0,0,0,0,1,1])   
    return binary

# Function to compute the vectors h
def h_vector(n):
    funds = binary_a(n)
    h = np.vstack([funds, [0,1,2,3,4,5,6,23]])
    # print('h_array = %s' % h   ) 
    return h
